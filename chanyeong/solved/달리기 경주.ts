(() => {
  const solution = (players_: string[], callings: string[]) => {
    ...
    for (const calledPlayer of callings) call(calledPlayer);
    return players;
  };
})();
